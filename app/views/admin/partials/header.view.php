...
<head>
  ...
  <link href="<?=BASE_URL?>/assets/css/style.css?v=<?= @filemtime(dirname(__DIR__, 4) . '/public/assets/css/style.css') ?>" rel="stylesheet" />
 ...
 <link href="<?=BASE_URL?>/assets/css/styles.min.css" rel="stylesheet" />
  <!-- <link href="<?=BASE_URL?>/assets/css/cleaned-tabs-style.css" rel="stylesheet" /> -->
 <link href="<?=BASE_URL?>/assets/plugins/datatable/css/dataTables.bootstrap5.min.css" rel="stylesheet" />
