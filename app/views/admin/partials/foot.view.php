  ...
  <script src="<?=BASE_URL?>/assets/js/form-select2.js"></script>
    <script src="<?=BASE_URL?>/assets/js/js_gare.js"></script>

    <script src="<?=BASE_URL?>/assets/plugins/js/bs-stepper.min.js"></script>
<script src="<?=BASE_URL?>/assets/plugins/js/main.js"></script>
...
<script src="<?=BASE_URL?>/assets/datatable/js/dataTables.bootstrap5.min.js"></script>
 <script src="<?=BASE_URL?>/mon_js/swt_alert.js"></script>
