                ...
                <div class="card-body border-bottom border-2 border-primary">
                    <ul class="nav nav-tabs nav-primary" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link " href="<?= BASE_URL ?>/admin/Caisse/bilant_caisse_billets" role="tab">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" href="<?= BASE_URL ?>/admin/Caisse/bilant_caisse_colis" role="tab">
                                <div class="d-flex align-items-center">
                                    <div class="tab-icon me-2">
                                ...
                                <?php if (!empty($liste_caisse)) : ?>
                                    <?php foreach ($liste_caisse as $caisse) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= number_format($caisse->montant_colis ?? 0, 0, ',', ' ') ?> FCFA
                                            </td>
                                            <td>
                                                <a href="#"
