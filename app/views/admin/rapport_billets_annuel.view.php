    ...
    <div class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Rapport annuel</div>
                <div class="ps-3">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-header bg-primary text-white">
                            <h5 class="mb-0">📅 Statistiques annuelles pour <?= $data['annee'] ?></h5>
                        </div>
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table table-striped table-hover mb-0 text-center">
                                    ...
                                    <tbody>
                                        <?php if (!empty($data['statsParAnnee'])): ?>
                                            <?php foreach ($data['statsParAnnee'] as $row): ?>
                                                <tr>
                                        ...
                                        <?php else: ?>
                                            <tr>
                                                <td colspan="3" class="text-center text-muted">Aucune donnée disponible pour cette année</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
            ...
            <!-- Table annuelle par localité et gare -->
            <div class="row mt-4">
                <div class="col-12">
                    <h4 class="mb-3">🏦 Situation des caisses et billets pour l’année <?= $data['annee'] ?></h4>
                    <div class="card shadow-sm">
                        <div class="card-body p-0">
                            <div class="table-responsive">
