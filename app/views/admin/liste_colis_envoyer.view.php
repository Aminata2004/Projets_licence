                                        ...
                                        <td class=" ">
                                            <div class="dropup ">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="<?= BASE_URL ?>/admin/Envoi_colis/envoi_colis?id_car=<?= $liste_colis_envoyers->numero_car ?>">Ajouter</a>
                                                    <a class="dropdown-item" href="#">Modifier</a>
                                                    <a class="dropdown-item" href="<?= BASE_URL ?>/admin/Envoi_colis/details_colis_envoyer?id_car=<?= $liste_colis_envoyers->numero_car ?>&date=<?= $liste_colis_envoyers->dates ?>">
                                                        Détails
                                                    </a>
