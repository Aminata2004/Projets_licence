                    ...
                    <div class="table-responsive mt-3">
                        <form action="" method="post">
                                    ...
                                    <?php if (!empty($cars_destinations)) : ?>
                                        <?php foreach ($cars_destinations as $numero_car => $destinations) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-select" name="id_horaire[]">
                                                        <option selected disabled value="">Sélectionner l'horaire</option>
                            ...
                            <div class="col-12 mt-4">
                                ...
                                <a href="<?= BASE_URL ?>/Programmation_voyages/liste_programmer_voyage" class="btn btn-info text-white">Voir la liste</a>
