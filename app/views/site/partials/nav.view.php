 <div class="header-top-section">
     <div class="container">
         <div class="header-top-wrapper bg-cover" style="background-image: url(<?= BASE_URL ?>/assets_site/img/header/12.png);">
             <ul class="top-left">
                 <li>
                     <i class="fa-solid fa-envelope"></i>
                     <a href="mailto:info@touron.com">amitacompt90@gmail.com</a>
                 </li>
                 <li>
