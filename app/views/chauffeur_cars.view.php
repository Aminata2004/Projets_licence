                                        ...
                                        <form action="" method="post">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="validationCustom01" name="nom_prenom" placeholder="Nom & prenom " required autocomplete="off">

                                                </div>
                                                <div class="col-md-6">
                                                    <label for="validationCustom02" class="form-label">Numero</label>
                                                    <input type="text" class="form-control" id="validationCustom02" name="numero" placeholder="Numero" required autocomplete="off">

                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <label for="validationCustomUsername" class="form-label">Cars</label>
