    ...
    public function index()
    {
        ...
        if (isset($_POST['reception'])) {
            ...
            if (empty($_POST['selected_colis'])) {
                ...
                header('Location: ' . BASE_URL . '/mouvement_colis');
                exit;
            }
...
HTML;
        ...
        $this->view('mouvement_colis', ['liste_colis' => $liste_colis, 'liste_colis_recue' => $liste_colis_recue, 'liste_colis_livre' => $liste_colis_livre]);
    }
}
