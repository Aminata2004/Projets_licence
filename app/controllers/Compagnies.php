...
class Compagnies extends  Controller
{
  ...
  public function index()
  {
    ...
    // Affichage de la vue
    $this->view('compagnies', ['liste' => $liste]);
  }
  ...
  public function edit()
  {
    ...
    if (isset($_POST['edit'])) {
      ...
      header("Location: " . BASE_URL . "/Compagnies/index");
      exit;
    }
  }
  ...
  public function place_limite()
  {
    ...
    $this->view('place_limite', ['liste_place' => $liste_place]);
  }
 ...
 public function edit1()
{
    ...
    if (isset($_POST['edit'])) {
        ...
        header("Location: " . BASE_URL . "/Compagnies/place_limite");
        exit;
    }
}
